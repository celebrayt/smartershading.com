...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'We found SmarterShading and had them outfit our Medina home. The motorized solar shades on our floor-to-ceiling windows are incredible. They integrated everything with our Lutron system seamlessly. Worth every penny.',
    product: 'Solar Shades',
    date: '2024-11-30',
  },
  {
    ...
    rating: 5,
    text: 'Living on the lake, sun reflecting off the water was blinding. SmarterShading installed motorized solar shades in our lakefront home and the difference is night and day. The Lutron integration works perfectly with our existing system. Professional from start to finish.',
    product: 'Motorized Window Shades',
    date: '2025-02-14',
  },
];
