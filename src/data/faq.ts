...
export const faqCategories: FAQCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { question: 'Do you serve areas outside Phoenix metro?', answer: 'Yes! While our primary service area is the Phoenix metro (Scottsdale, Paradise Valley, Tempe, Mesa, Chandler, Gilbert, Glendale), we also serve Tucson, Washington State (Seattle, Bellevue, Tacoma, Spokane), and Northern Idaho (Coeur d\\\'Alene, Post Falls, Sandpoint).' },
    ],
  },
  {
    name: 'Pricing',
