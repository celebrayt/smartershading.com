        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <div className="aspect-[4/3] bg-gradient-to-br from-sand/20 to-sand-dark/20 rounded-2xl flex items-center justify-center">
                <svg className="w-24 h-24 text-sand/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
